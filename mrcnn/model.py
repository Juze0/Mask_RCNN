...
def fpn_classifier_graph(rois, feature_maps, image_meta, pool_size, num_classes, train_bn=True, fc_layers_size=1024):
    ...
    Returns:
        ...
        bbox [batch, num_rois, NUM_CLASSES, (dy, dx, log(dh), log(dw))] Deltas to apply to proposals
    """
    # ROI Pooling
...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        shape = tf.shape(input_image)  # Définition de shape
        assert shape is not None, "Shape cannot be None"  # Vérification de shape
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        tf.keras_model = self.keras_model
